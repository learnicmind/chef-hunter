...
const DonationSection = () => {
    return (
        <section className=" py-12 lg:py-24 bg-slate-200 w-9/12 mx-auto">
            <h2 className='text-center text-4xl font-bold text-gray-800 md:pb-10 py-4'>Our Commitment to Reducing Food Insecurity</h2>
            <div className="grid md:grid-cols-2">
                ...
                <div className='flex items-center px-4 py-4'>
                    ...
                    <h2 className="text-gray-700 text-lg md:mb-6 text-center">
